...
##### vpc #####
vpc_count = 2
vpc_name = ["staging-vpc-1", "staging-vpc-2"]

##### subnet #####
subnet_count = 2
subnet_names = ["staging-subnet-1", "staging-subnet-2"]
...
instance_names = ["staging-instance-1", "staging-instance-2"]
...
##### firewalls ######
firewall_count = 2
firewall_names = ["stag-firewall-ports-1", "stag-firewall-ports-2"]
network_names = ["staging-vpc-1", "staging-vpc-2"]
protocols = ["tcp", "tcp"]
...
##### data-disks #####
data_disk_count = 2
data_disks = ["stag-data-disk-1", "stag-data-disk-2"]
disk_types = ["pd-standard", "pd-standard"]
disk_zones = ["us-central1-f", "us-central1-f"]
boot_disk_size = [50, 50]
vm_names = ["staging-instance-1", "staging-instance-2"]